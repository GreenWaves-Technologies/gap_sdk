...
/* Reserved/Not used. */
#define CPI_CFG_GLOB_RESERVED_0_MASK                                 (0x7fff8000)
#define CPI_CFG_GLOB_RESERVED_0_SHIFT                                (15)
#define CPI_CFG_GLOB_RESERVED_0(val)                                 (((uint32_t)(((uint32_t)(val)) << CPI_CFG_GLOB_RESERVED_0_SHIFT)) & CPI_CFG_GLOB_RESERVED_0_MASK)
...
/*! @name CFG_SIZE */
/* Reserved/Not used. */
#define CPI_CFG_SIZE_RESERVED_0_MASK                                 (0xffff)
#define CPI_CFG_SIZE_RESERVED_0_SHIFT                                (0)
#define CPI_CFG_SIZE_RESERVED_0(val)                                 (((uint32_t)(((uint32_t)(val)) << CPI_CFG_SIZE_RESERVED_0_SHIFT)) & CPI_CFG_SIZE_RESERVED_0_MASK)
...
/* Reserved/Not used. */
#define CPI_CFG_FILTER_RESERVED_0_MASK                               (0xff000000)
#define CPI_CFG_FILTER_RESERVED_0_SHIFT                              (24)
#define CPI_CFG_FILTER_RESERVED_0(val)                               (((uint32_t)(((uint32_t)(val)) << CPI_CFG_FILTER_RESERVED_0_SHIFT)) & CPI_CFG_FILTER_RESERVED_0_MASK)

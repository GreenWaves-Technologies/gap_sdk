...
static test_fixed_data_t test_fixed_datas[] = {
    ...
    },
    {
        ...
        .size = 16,
        .precisions = { 0, 8, 12, 15},
        .scales = {0, 4, 8},
    },
    {
        .type = PI_FFC_FIXED_24,
        .size = 24,
        .precisions = { 0, 12, 16, 23},
        .scales = {0, 4, 8},
    },
    {
        .type = PI_FFC_FIXED_32,
        .size = 32,
        .precisions = { 0, 16, 24, 31},
        .scales = {0, 4, 8},
    },
};
...
static void reset_data(void)
{
    ...
    {
        fx2fl_points_src[i] = 0;
        fx2fl_points_ffc_dst[i] = 0;
        fx2fl_points_sw_dst[i] = 0;

        fl2fx_points_src[i] = 0;
        fl2fx_points_ffc_dst[i] = 0;
        fl2fx_points_sw_dst[i] = 0;
    }
}

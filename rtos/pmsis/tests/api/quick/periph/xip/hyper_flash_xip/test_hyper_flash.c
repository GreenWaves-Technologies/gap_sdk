...
#define XIP_LOAD_ADDR  ((volatile uint32_t*)0x20000000)
#define XIP_STOR_ADDR  ((volatile uint32_t*)0x20000004)
...
//#endif
    ...
    int ret = 0;
    if((ret =pi_xip_mount(xip_device,xip_buff,0x40000000UL + hyper_buff,mount_size,0)))
    {

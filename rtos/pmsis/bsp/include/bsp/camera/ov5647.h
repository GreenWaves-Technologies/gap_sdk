...
#ifndef __BSP_CAMERA_OV5647_H__
#define __BSP_CAMERA_OV5647_H__
...
/** \struct pi_ov5647_conf
 * \brief Ov5647 configuration structure.
 *
 * This structure is used to pass the desired Ov5647 configuration to the

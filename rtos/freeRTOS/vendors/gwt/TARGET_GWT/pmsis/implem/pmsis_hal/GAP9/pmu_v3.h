...
#include "periph/maestro_periph.h"
#include "memory_map.h"
#include "events.h"

#define IP_WRITE(addr,offset,value) (hal_write32((volatile uint32_t *)((addr)+(offset)), value))
#define IP_READ(addr,offset) (hal_read32((volatile uint32_t *)((addr)+(offset))))

...
#ifndef __UDMA_UART_PERIPH_H__
#define __UDMA_UART_PERIPH_H__
...
#define UART_SETUP_CLEAN_FIFO(val)                                   (((uint32_t)(((uint32_t)(val)) << UART_SETUP_CLEAN_FIFO_SHIFT)) & UART_SETUP_CLEAN_FIFO_MASK)

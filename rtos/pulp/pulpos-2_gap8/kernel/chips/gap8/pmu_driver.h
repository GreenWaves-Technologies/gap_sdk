...
extern unsigned int PI_L2 	DCDC_MaxFreq[DCDC_OPER_POINTS];
extern PI_L2 unsigned int 	FllsFrequency[N_FLL];
extern PMU_RetentionStateT PI_L2 	PMURetentionState;

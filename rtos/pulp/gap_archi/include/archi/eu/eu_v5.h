/*
 * Copyright (C) 2020 GreenWaves Technologies, ETH Zurich and
...
#ifndef __ARCHI_EU_EU_V4_H__
#define __ARCHI_EU_EU_V4_H__
...
#define EU_SEM_SIZE_LOG2                    4
#define EU_SEM_SIZE                         (1<<EU_SEM_SIZE_LOG2)
#define EU_BITFIELD_SIZE_LOG2               4
#define EU_BITFIELD_SIZE                    (1<<EU_BITFIELD_SIZE_LOG2)
#define EU_TASK_DISPATCH_SIZE_LOG2          7
#define EU_TASK_DISPATCH_SIZE               (1<<EU_TASK_DISPATCH_SIZE_LOG2)
...
#define EU_TASK_DISPATCH_AREA_SIZE          0x100
...
#define EU_TASK_DISPATCH_DEMUX_OFFSET       0x0500
#define EU_TASK_DISPATCH_DEMUX_SIZE         0x0100
...
#define EU_HW_BITFIELD_SET                  0x04
#define EU_HW_BITFIELD_CLEAR                0x08
#define EU_HW_BITFIELD_ALLOC                0x0C
...
// Task dispatch
#define EU_TASK_DISPATCH_CORE_MASK          0x0
#define EU_TASK_DISPATCH_POP                0x4
#define EU_TASK_DISPATCH_TRY_POP            0x8
#define EU_TASK_DISPATCH_TEAM_WAIT          0xC
#define EU_TASK_DISPATCH_ID                 0x10
#define EU_TASK_DISPATCH_END                0x14
#define EU_TASK_DISPATCH_PUSH_MASK          0x18
#define EU_TASK_DISPATCH_PUSH_1             0x1C
#define EU_TASK_DISPATCH_PUSH_2             0x20
#define EU_TASK_DISPATCH_PUSH_3             0x24
#define EU_TASK_DISPATCH_PUSH_4             0x28
#define EU_TASK_DISPATCH_PUSH_5             0x2C
#define EU_TASK_DISPATCH_PUSH_6             0x30
#define EU_TASK_DISPATCH_PUSH_7             0x34
#define EU_TASK_DISPATCH_PUSH_8             0x38
#define EU_TASK_DISPATCH_PUSH_9             0x3C
...
#define EU_SEM_AREA_OFFSET_GET(sem)                     ((sem)*EU_SEM_SIZE)
#define EU_SEM_AREA_SEMID_GET(offset)                   (((offset) & (EU_SEM_AREA_SIZE - 1)) >> EU_SEM_SIZE_LOG2)
#define EU_TASK_DISPATCH_AREA_TASK_DISPATCHID_GET(offset)         (((offset) & (EU_TASK_DISPATCH_AREA_SIZE - 1)) >> EU_TASK_DISPATCH_SIZE_LOG2)
#define EU_BITFIELD_AREA_OFFSET_GET(bitfield)           ((bitfield)*EU_BITFIELD_SIZE)
#define EU_BITFIELD_AREA_BITFIELDID_GET(offset)         (((offset) & (EU_BITFIELD_AREA_SIZE - 1)) >> EU_BITFIELD_SIZE_LOG2)

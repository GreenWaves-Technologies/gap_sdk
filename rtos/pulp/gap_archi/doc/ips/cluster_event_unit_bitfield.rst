...
.. table:: 
    ...
    +================================================+======+=====+================================================+
    |:ref:`VALUE<cluster_event_unit_bitfield__VALUE>`|     0|   32|Set or get the value of the bitfield            |
    +------------------------------------------------+------+-----+------------------------------------------------+
    |:ref:`SET<cluster_event_unit_bitfield__SET>`    |     4|   32|Selectively set bitfield bits                   |
    +------------------------------------------------+------+-----+------------------------------------------------+
    |:ref:`CLEAR<cluster_event_unit_bitfield__CLEAR>`|     8|   32|Selectively clear bitfield bits                 |
    +------------------------------------------------+------+-----+------------------------------------------------+
    |:ref:`ALLOC<cluster_event_unit_bitfield__ALLOC>`|    12|   32|Get position and clear least significant set bit|
    +------------------------------------------------+------+-----+------------------------------------------------+

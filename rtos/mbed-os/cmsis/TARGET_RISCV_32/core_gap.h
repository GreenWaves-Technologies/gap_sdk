...
#define DMAMCHAN_CMD_2D_TCDM_Pos                23U                              /*!< DMAMCHAN Broadcast Lines Enable Position */
#define DMAMCHAN_CMD_2D_TCDM_Msk                (1UL << DMAMCHAN_CMD_2D_TCDM_Pos)/*!< DMAMCHAN CMD Broadcast Lines Enable Mask */

#define DMAMCHAN_CMD_BLE_Pos                    22U                              /*!< DMAMCHAN Broadcast Lines Enable Position */
#define DMAMCHAN_CMD_BLE_Msk                    (1UL << DMAMCHAN_CMD_BLE_Pos)    /*!< DMAMCHAN CMD Broadcast Lines Enable Mask */

#define DMAMCHAN_CMD_ILE_Pos                    21U                              /*!< DMAMCHAN Intrrupt Line EnableID Position */
#define DMAMCHAN_CMD_ILE_Msk                    (1UL << DMAMCHAN_CMD_ILE_Pos)    /*!< DMAMCHAN Intrrupt Line Enable Mask */

#define DMAMCHAN_CMD_ELE_Pos                    20U                              /*!< DMAMCHAN CMD Event Line Enable Position */
#define DMAMCHAN_CMD_ELE_Msk                    (1UL << DMAMCHAN_CMD_ELE_Pos)    /*!< DMAMCHAN CMD Event Line Enable Mask */

#define DMAMCHAN_CMD_2D_Pos                     19U                              /*!< DMAMCHAN CMD 2D transfer Position */
#define DMAMCHAN_CMD_2D_Msk                     (1UL << DMAMCHAN_CMD_2D_Pos)     /*!< DMAMCHAN CMD 2D transfer Mask */

#define DMAMCHAN_CMD_INC_Pos                    18U                              /*!< DMAMCHAN CMD Increment Position */
#define DMAMCHAN_CMD_INC_Msk                    (1UL << DMAMCHAN_CMD_INC_Pos)    /*!< DMAMCHAN CMD Increment Mask */

#define DMAMCHAN_CMD_TYP_Pos                    17U                              /*!< DMAMCHAN CMD Type Position */
#define DMAMCHAN_CMD_TYP_Msk                    (1UL << DMAMCHAN_CMD_TYP_Pos)    /*!< DMAMCHAN CMD Type Mask */

#define DMAMCHAN_CMD_LEN_Pos                    0U                               /*!< DMAMCHAN CMD Length Position */
#define DMAMCHAN_CMD_LEN_Msk                    (0x1FFFFUL /*<< DMAMCHAN_EOC_Pos*/) /*!< DMAMCHAN CMD Length Mask */

#define DMAMCHAN_CMD_2D_STRIDE_Pos              0U                               /*!< DMAMCHAN CMD 2D STRIDE Position */
#define DMAMCHAN_CMD_2D_STRIDE_Msk              (0xFFFFFFFFUL /* << DMAMCHAN_CMD_2D_STRIDE_Pos*/) /*!< DMAMCHAN CMD 2D STRIDE Mask */
#define DMAMCHAN_CMD_2D_COUNT_Pos               0U                               /*!< DMAMCHAN CMD 2D COUNT Position */
#define DMAMCHAN_CMD_2D_COUNT_Msk               (0xFFFFFFFFUL /* << DMAMCHAN_CMD_2D_COUNT_Pos*/)  /*!< DMAMCHAN CMD 2D COUNT Mask */
#endif
...
#elif defined(__GAP9__)
    vectors = (uint32_t *)(__builtin_pulp_spr_read(0x005) & ~MTVEC_MODE_Msk);
#endif
  }

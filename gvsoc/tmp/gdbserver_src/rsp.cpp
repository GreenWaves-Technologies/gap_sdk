...
bool Rsp::query(char* data, size_t len)
{
    ...
    {
        snprintf(reply, REPLY_BUF_LEN, "PacketSize=%x", RSP_PACKET_MAX_SIZE);
...
{
    fprintf(stderr, "Received packet: '%s' (len: %ld)\n", data, len);

...
#ifndef __PULP_UDMA_UDMA_CPI_V2_HPP__
#define __PULP_UDMA_UDMA_CPI_V2_HPP__

#include <udma_cpi/udma_cpi_regs.h>
#include <udma_cpi/udma_cpi_regfields.h>
#include <udma_cpi/udma_cpi_macros.h>
#include <udma_cpi/udma_cpi_gvsoc.h>
...
{
public:
  Cpi_rx_channel(udma *top, Cpi_periph *periph, string name);

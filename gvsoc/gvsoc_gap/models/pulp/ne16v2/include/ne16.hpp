...
#define NE16_REG_PADDING0          20
#define NE16_REG_PADDING1          8
#define NE16_REG_PADDING2          24
#define NE16_REG_WEIGHT_OFFSET     21
#define NE16_REG_FILTER_MASK       22
#define NE16_REG_CONFIG0           23

#define NE16_NB_REG 25
...
private:
    ...
    int subtile_rem_wi;
    int padding_top_nb;
    int padding_right_nb;
    int padding_bottom_nb;
    int padding_left_nb;
    int padding_top_init;
    int padding_right_init;
    int padding_bottom_init;
    int padding_left_init;
    int padding_top_stride;
    int padding_right_stride;
    int padding_bottom_stride;
    int padding_left_stride;
    int padding_top_current;
    int padding_right_current;
    int padding_bottom_current;
    int padding_left_current;
    int padding_value;
    int Wmin;

...
export TILER_BILINEAR_RESIZE_GENERATOR_PATH=$TILER_GENERATOR_PATH/Resize
export TILER_BILINEAR_RESIZE_KERNEL_PATH=$TILER_GENERATOR_PATH/Resize
export TILER_INTEGRAL_GENERATOR_PATH=$TILER_GENERATOR_PATH/IntegralImg
export TILER_INTEGRAL_KERNEL_PATH=$TILER_GENERATOR_PATH/IntegralImg
export TILER_FFT2D_GENERATOR_PATH=$TILER_GENERATOR_PATH/FFT2D
export TILER_FFT2D_KERNEL_PATH=$TILER_GENERATOR_PATH/FFT2D
export TILER_FFT2D_TWIDDLE_PATH=$TILER_GENERATOR_PATH/FFT2D/twiddles_gen

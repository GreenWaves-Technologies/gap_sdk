...
def gen_at_linear_relu(code_block, cname, in_dim, out_dim, linear_oper, act_oper, gen_ctrl, at_ver=3):
    del at_ver
    code_block.write('CNN_LinearAct_fp16("{}", {}, {}, {}, {}, {});',
                     cname,
                     gen_ctrl,
                     in_dim,
                     out_dim,
...
@kernel_sources(
    '$(TILER_CNN_KERNEL_PATH_FP16)/CNN_Bias_Linear_Activation_fp16.c')
...
class LinearReluKernel(AutotilerKernel):
    ...
    def code(self, code_block=None):
        ...
        gen_at_linear_relu(code_block, self.cname, self.in_dim, self.out_dim,

...
from generation.generators.generator_decorators import (QREC_MULT8,
                                                        generation_function)
from graph.types import ImageFormatParameters, TransposeParameters, CopyParameters, ResizerParameters


@generation_function("bindings", (TransposeParameters, ImageFormatParameters, CopyParameters, ResizerParameters), qrec_types=(QREC_MULT8, ))

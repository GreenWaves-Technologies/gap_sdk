...
from generation.bindings import (CommentBindingList, GNodeArgEdge,
                                 NodeBindingList)
from generation.generator_decorators import (QREC_MULT8, QREC_POW2, QREC_FLOAT,
                                             generation_function)
from graph.types import ExpressionFusionParameters


@generation_function("bindings", (ExpressionFusionParameters, ), qrec_types=(QREC_MULT8, QREC_POW2, QREC_FLOAT))

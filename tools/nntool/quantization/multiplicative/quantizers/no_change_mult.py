...
from graph.types import (OutputParameters, PoolingParameters,
...
@params_type(PoolingParameters, OutputParameters, SplitParameters, ReshapeParameters, TransposeParameters)

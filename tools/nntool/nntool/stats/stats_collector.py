...
class StatsCollector(ABC):
    ...
    @abstractmethod
    def _collect(self, G, step_idx) -> Mapping[Union[str, Tuple], Mapping]:
        pass
...
class ReductionStatsCollector(GraphStatsCollector):
    ...
    @abstractmethod
    def _collect(self, G, input_tensors, step_idx) -> Mapping[Union[str, Tuple], Mapping]:
        pass
    ...
    @abstractmethod
    def _reduce_prepare(self, all_stats: Sequence[Mapping[Union[str, Tuple], Mapping]])\
        -> Mapping[Union[str, Tuple], Mapping]:
        pass

    @abstractmethod
    def _reduce(self,
                key: Union[str, Tuple],
                base: Mapping[Union[str, Tuple], Mapping],
                stat: Mapping[Union[str, Tuple], Mapping]):
        pass

    @abstractmethod
    def _reduce_finalize(self, stats: Mapping) -> Mapping[Union[str, Tuple], Mapping]:
        pass

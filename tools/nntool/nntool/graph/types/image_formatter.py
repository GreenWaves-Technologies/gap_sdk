...
from .base import NNNodeBase, SensitiveToOrderMixin, SingleInputAndOutputMixin, cls_op_name

LOG = logging.getLogger(__name__)

@cls_op_name('image_format')
class ImageFormatNode(NNNodeBase, SingleInputAndOutputMixin, SensitiveToOrderMixin):
    ...
    def __init__(self, *args, norm_func=None, format_change=None, **kwargs):
        ...
        super(ImageFormatNode, self).__init__(*args, **kwargs)

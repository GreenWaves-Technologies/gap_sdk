...
from .base import NNNodeBase, SensitiveToOrderMixin, cls_op_name, nargs
...
class SSDDetectorNode(NNNodeBase, SensitiveToOrderMixin):

    INPUT_NAMES = SSD_INPUT_NAMES

    def __init__(self, *args, parameters=None, **kwargs):
        super(SSDDetectorNode, self).__init__(*args, **kwargs)
    ...
    def attrs(self) -> dict:
        ...
        super_attrs['parameters'] = repr(self._parameters)
        return super_attrs
...
class NMSNode(NNNodeBase, SensitiveToOrderMixin):
    ...
    def __init__(self, *args, parameters=None, in_dims_hint=None, out_dims_hint=None,
        ...
        if ker_in_order is None:
            ker_in_order = [['batch', 'spatial_dim', 'box'], [
                'batch', 'class', 'spatial_dim']]
        if ker_out_order is None:
            ker_out_order = [['spatial_dim', 'index']]
        super(NMSNode, self).__init__(
            *args, in_dims_hint=in_dims_hint, out_dims_hint=out_dims_hint,

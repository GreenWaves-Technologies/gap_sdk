...
from ..types import (ConcatNode, ConstantInputNode, EdgeParameters,
                     InputNode, OutputNode, NNNodeBase,
...
def set_out_edges_multi(G, node: NNNodeBase, dims: Sequence[Dim], step_idx: int,
...
def set_out_edges_one(G, node: NNNodeBase, dim: Dim, step_idx: int,
                      naming_convension: NamingConvension, update_graph, edge_type: str = "in_out"):
...
def validate_one_in_edge(G, node: NNNodeBase, update_graph, expect_named: bool = True):
...
def validate_multi_in_edge(G, node: NNNodeBase, update_graph, expect_named: bool = True):
    dims = []
...
def add_dimensions_concat(G, node: NNNodeBase, step_idx: int,
...
def add_dimensions_constant(G, node: NNNodeBase, step_idx: int,
...
def add_dimensions_input(G, node: NNNodeBase, step_idx: int,
                         naming_convension: NamingConvension, indexes, update_graph):
...
def add_dimensions_output(G, node: NNNodeBase, step_idx: int,
                          naming_convension: NamingConvension, indexes, update_graph):
...
def add_dimensions_unknown_single(G, node: NNNodeBase, step_idx: int,
                                  naming_convension: NamingConvension, indexes, update_graph):
    del indexes
    eparams = validate_one_in_edge(G, node, update_graph, expect_named=False)
    if update_graph:
...
def add_dimensions_unknown(G, node: NNNodeBase, step_idx: int,
...
OP_ROUTINES = {
    InputNode: add_dimensions_input,
    OutputNode: add_dimensions_output,
    ConcatNode: add_dimensions_concat,
    ConstantInputNode: add_dimensions_constant,
    SingleInputAndOutputMixin: add_dimensions_unknown_single
}

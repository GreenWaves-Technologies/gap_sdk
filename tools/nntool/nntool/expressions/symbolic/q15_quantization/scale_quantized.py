...
from ..basic import Add, Cast, CompoundFunction, LShift, Mul, Sub, copy_props, Norm
...
class ScaleQuantized(CompoundFunction):
    def __init__(self, *args, from_qrec=None, to_qrec=None, qrec=None, num_bits=8, **kwargs):
        assert qrec is None or qrec == to_qrec

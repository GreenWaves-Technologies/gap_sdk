...
import numpy as np
from nntool.graph.dim import Conv2DFilterDim, DilationDim, Dim, Dim2D, PadDim, StrideDim
from nntool.graph.types import ConstantInputNode, TransposeConv2DParameters, ReshapeNode
...
class ConvTranspose(BackendHandler, ConstantMixin):
    ...
    def _common(cls, node, **kwargs):
        ...
        if conv_shape != real_in_shape:
            ...
            rbatch_params = ReshapeNode(G.unique_name(f'{valid_name}_reshape_batchdim'),

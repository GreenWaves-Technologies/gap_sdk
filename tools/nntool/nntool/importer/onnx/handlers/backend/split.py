...
import numpy as np
from nntool.graph.types import ConstantInputNode, NNEdge, SplitNode
...
class Split(ConstantMixin, BackendHandler):
    ...
    def _common(cls, node, **kwargs):
        ...
        params = SplitNode(valid_name, act_slices=act_slices,
        ...
        if cls.is_constant(x):
            ...
            for idx, out_pshape in enumerate(out_pshapes):
                cparams = ConstantInputNode(valid_name, value=values[idx])

...
from nntool.graph.types.tensor_arithmetic import MatrixDivNode

from ..backend_handler import BackendHandler
from ..handler import tflite_op
from .math_mixin import ArithmeticMixin
from nntool.importer.tflite2.tflite_schema_head.DivOptions import DivOptions

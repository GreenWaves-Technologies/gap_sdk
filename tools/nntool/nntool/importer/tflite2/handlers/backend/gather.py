...
from nntool.importer.tflite2.tflite_schema_head.GatherOptions import GatherOptions
    ...
    def _common(cls, node: TFLiteNode, **kwargs):
        ...
        if cls._is_constant(x):
            ...
            if len(strides) != 1 or len(lengths) != 1:
                raise TFLiteImportException(f'Irregular GATHER {node.name} not supported')

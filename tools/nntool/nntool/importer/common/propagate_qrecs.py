...
import numpy as np
from nntool.graph.types import (MaxPoolNode, OutputNode, LinearNode, Conv2DNode,
                         ReluNode, ReshapeNode,
...
INFERRED_NODES = {
    SoftMaxNode: overwrite_range(((-16.0, 16.0),), ((0.0, 1.0),)),
    OutputNode: pass_qtype,
    ReluNode: pass_qtype_up,
    MaxPoolNode: pass_qtype,
    TransposeNode: pass_qtype,
    ReshapeNode: pass_qtype,
    Conv2DNode: pass_filter,
    LinearNode: pass_filter,

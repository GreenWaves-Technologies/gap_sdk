...
from nntool.quantization.qtype import QType, DTYPES
from nntool.quantization.quantizer_options import QTYPE_IND_OPTION, OUTPUT_SIZE_OPTION
from nntool.quantization.unified_quantization_handler import (needs_stats, options,
                                                       params_type)

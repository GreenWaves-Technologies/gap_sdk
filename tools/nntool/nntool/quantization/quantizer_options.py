...
ALLOW_ASYMMETRIC_OUT_OPTION = {
    'name': 'allow_asymmetric_out',
    'type': bool,
    'help': 'Allow soft kernels to use asymmetric quantization where possible. '
    'This option defaults to False on inputs and outputs except for inputs if their minimum '
    'value in the statistics is 0 in which case it is always True.',
    'default': True
}

ALLOW_ASYMMETRIC_OUT_OPTION_DEFAULT_FALSE = ALLOW_ASYMMETRIC_OUT_OPTION.copy()
ALLOW_ASYMMETRIC_OUT_OPTION_DEFAULT_FALSE['default'] = False
...
FORCE_RNN_1_MINUS_1_OUT = {
    'name': 'force_rnn_1_minus_1_out',
    'type': bool,
    'help': 'forces RNNs to have narrow, symmetric 1 - -1 output',
    'default': False
}

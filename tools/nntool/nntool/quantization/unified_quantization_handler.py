...
from nntool.quantization.clipping import CLIP_TYPE_OPTION
from nntool.quantization.qtype_constraint import ConstraintBase, MatchAll
from nntool.quantization.range_provider import RangeProviderBase
...
class QuantizionHandlerBase(ConstraintBase):
    ...
    @classmethod
    def get_in_qs_from_stats(cls, params, stats: RangeProviderBase.RangeProviderWrapper, in_qs, **kwargs):
        return cls._get_in_qs_from_stats(params, stats, in_qs, **kwargs)

    @classmethod
    def _get_in_qs_from_stats(cls, params, stats: RangeProviderBase.RangeProviderWrapper, in_qs, **kwargs):
        raise NotImplementedError("no _get_in_qs_from_stats method implemented")

    @classmethod
    def _quantize(cls, params, in_qs, stats: RangeProviderBase.RangeProviderWrapper, **kwargs):
    ...
    @classmethod
    def quantize(cls, params, in_qs, stats: RangeProviderBase.RangeProviderWrapper, **kwargs):
...
params_type = QuantizionHandlerBase.params_type
documentation = QuantizionHandlerBase.documentation
options = QuantizionHandlerBase.options
option_constraint = QuantizionHandlerBase.option_constraint
can_dequantize = QuantizionHandlerBase.can_dequantize
scheme = QuantizionHandlerBase.scheme
in_qs_constraint = QuantizionHandlerBase.in_qs_constraint
out_qs_constraint = QuantizionHandlerBase.out_qs_constraint
fusion_handler = QuantizionHandlerBase.fusion_handler
priority = QuantizionHandlerBase.priority
needs_stats = QuantizionHandlerBase.needs_stats

@options(
    CLIP_TYPE_OPTION
)
#pylint: disable=abstract-method
class QuantizionHandler(QuantizionHandlerBase):
    pass

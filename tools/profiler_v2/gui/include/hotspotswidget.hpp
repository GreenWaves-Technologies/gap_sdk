...
#ifndef HOTSPOTWIDGET_HPP
#define HOTSPOTWIDGET_HPP
...
private :
    ...
    // All hotspots ordered by duration
    std::list<Hotspot_info *> beHotspots;
    std::list<SafeHotspot> hotspots;
    // All the hotspots ordered by line

...
#ifndef HOTSPOTLINEWIDGET_HPP
#define HOTSPOTLINEWIDGET_HPP
...
/**
  ...
  */
class HotspotsLineWidget : public QWidget
{
    Q_OBJECT
...
public :
    HotspotsLineWidget(QWidget* parent,
...
private :
    ...
    std::list<Hotspot_line_info *> beHotspots;
    std::list<SafeHotspotLineInfo> hotspots;

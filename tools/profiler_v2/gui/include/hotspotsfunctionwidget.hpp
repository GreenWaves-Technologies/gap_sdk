...
#ifndef HOTSPOTSFUNCTIONWIDGET_HPP
#define HOTSPOTSFUNCTIONWIDGET_HPP
...
/**
  ...
  */
class HotspotsFunctionWidget : public QWidget
{
    Q_OBJECT
...
public :
    HotspotsFunctionWidget(QWidget* parent,
...
private :
    ...
    std::list<Hotspot_function_info *> beHotspots;
    std::list<SafeHotspotFunctionInfo> hotspots;
...
#endif //HotspotsFunctionWidget_HPP

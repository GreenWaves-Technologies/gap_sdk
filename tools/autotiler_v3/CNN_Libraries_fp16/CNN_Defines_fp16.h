...
/* Float Activation Functions */
	...
	#include "../DSP_Libraries/FloatLutFuncs.h"
		...
		#define FastPowF16(__x, __p)		fastpow_f16(__x, __p)
		#define FastPowF16V(__x, __p)		fastpow_v2h(__x, __p)
		#define FastPow2F16(__x) 		fastpow2_f16(__x)
		#define FastPow2F16V(__x) 		fastpow2_v2h(__x)
		#define FastLogF16(__x) 		fastlog_f16(__x)
		#define FastLogF16V(__x) 		fastlog_v2h(__x)
		#define SqrtF16(__x)			Sqrtf16(__x)
	#else
		...
		#define FastPowF16(__x, __p)		fastpow_f16a(__x, __p)
		#define FastPowF16V(__x, __p)		fastpow_v2ah(__x, __p)
		#define FastPow2F16(__x) 		fastpow2_f16a(__x)
		#define FastPow2F16V(__x) 		fastpow2_v2h(__x)
		#define FastLogF16(__x) 		fastlog_f16a(__x)
		#define FastLogF16V(__x) 		fastlog_v2ah(__x)
		#define SqrtF16(__x)			Sqrtf16a(__x)
	#endif // STD_FLOAT

...

{
  ...
  if (Inverse) {
    ...
    *InOutB = ((A - C) - gap_sub2rotmj(B,  D)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutC = ((A + C) -	           (B + D)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutD = ((A - C) + gap_sub2rotmj(B,  D)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
  } else {
    *InOutA = ((A + C) +	           (B + D)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutB = ((A - C) + gap_sub2rotmj(B,  D)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutC = ((A + C) -	           (B + D)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
...

{
  ...
  B1 = gap_cplxmuls(B, W1); C1 = gap_cplxmuls(C, W2); D1 = gap_cplxmuls(D, W3);

  if (Inverse) {
    *InOutA = ((A + C1) +               (B1 + D1)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutB = ((A - C1) - gap_sub2rotmj(B1,  D1)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutC = ((A + C1) -               (B1 + D1)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutD = ((A - C1) + gap_sub2rotmj(B1,  D1)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
  } else {
    *InOutA = ((A + C1) +               (B1 + D1)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutB = ((A - C1) + gap_sub2rotmj(B1,  D1)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
    *InOutC = ((A + C1) -               (B1 + D1)) >> (v2s) {FFT4_SCALEDOWN, FFT4_SCALEDOWN};
  ...
  for (iCnt1 = 0; iCnt1 < (iLog2N-1); iCnt1++) {
    ...
    for (iCnt2 = 0; iCnt2 < iM; iCnt2++) {
      ...
      for (iCnt3 = 0; iCnt3 < iL; iCnt3++) {
        ...
        DataV[TileW*iB] = gap_cplxmulsdiv2(Tmp, W);
        iA = iA + 2 * iM;
      }
      iQ += iL;
    }

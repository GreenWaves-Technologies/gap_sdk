...
def create_model(fingerprint_input, model_settings, model_architecture,
                 is_training, runtime_settings=None, print_outputs=False):
  ...
  if model_architecture == 'single_fc':
    ...
    return create_conv_model(fingerprint_input, model_settings, is_training,print_outputs)
...
def create_conv_model(fingerprint_input, model_settings, is_training, print_outputs=False):
  ...
  if is_training:
    ...
    if print_outputs:
      return final_fc , max_pool, first_weights, first_bias, second_weights, second_bias, final_fc_weights,  second_relu
    else:
      return final_fc

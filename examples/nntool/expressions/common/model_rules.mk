...
# $(MODEL_STATE): $(MODEL_TFLITE) $(SAMPLES) $(NNTOOL_SCRIPT) | $(MODEL_BUILD)
...
$(SAMPLES):
	mkdir samples
	python3 model/generate_dummy_inout.py
...
$(MODEL_BUILD)/$(MODEL_SRC): $(MODEL_TFLITE) | $(MODEL_BUILD) $(SAMPLES)
	...
	sed -e "s|MODEL_SRC|$(MODEL_SRC)|g" -e "s|TENSORS_DIR|$(TENSORS_DIR)|g" -e "s|MODEL_BUILD|$(MODEL_BUILD)|g" \

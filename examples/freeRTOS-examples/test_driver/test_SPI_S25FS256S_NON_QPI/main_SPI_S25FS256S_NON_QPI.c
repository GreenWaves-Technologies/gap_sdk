...
void vTestSPINonQPI( void *parameters );
...
void vTestSPINonQPI( void *parameters )
{
    ...
    printf("%s executing SPINonQPI function :\n\n", taskname);

    SPI_FLASH_Init( SPI0_SDIO0, SPI0_SDIO1, SPI0_SCLK, SPI0_CSN0, 32, 0, 10000000, 0, 0 );
    ...
    /* Erase page */
    SPI_FLASH_Erase( 0x000, BUF_SIZE );
    printf("Flash erased ... \n");
    ...
    /* Read back buffer */
    SPI_FLASH_Read( 0x000, BUF_SIZE, rxBuffer );
    printf("Flash read ... \n");

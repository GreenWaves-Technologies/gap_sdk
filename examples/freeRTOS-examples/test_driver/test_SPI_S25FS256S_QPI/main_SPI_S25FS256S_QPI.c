...
void vTestSPI_QPI( void *parameters )
{
    ...
    SPI_FLASH_Init( SPI0_SDIO0, SPI0_SDIO1, SPI0_SCLK, SPI0_CSN0, 32, 0, 10000000, 1, 0 );
    ...
    /* Erase page */
    SPI_FLASH_Erase( 0x200, BUF_SIZE );
    printf("Flash erased ...\n");

    /* Write buffer */
    SPI_FLASH_Write( 0x200, BUF_SIZE, txBuffer );
    printf("Flash written ...\n");

    /* Read back buffer */
    SPI_FLASH_Read( 0x200, BUF_SIZE, rxBuffer );
    printf("Flash read ...\n");

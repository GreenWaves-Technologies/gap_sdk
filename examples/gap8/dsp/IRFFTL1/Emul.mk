...
INCLUDES += -I. -I$(AT_HOME)/DSP_Libraries/ -I$(AT_HOME)/DSP_Libraries/LUT_Tables -I$(TILER_INC) -I$(TILER_EMU_INC) #-DPRINTDEB #-DDEBUG
CFLAGS 	 += -DMAXDIM=$(MAXDIM) -DMINDIM=$(MINDIM) -DDATA_TYPE=$(DATA_TYPE)

...
int test_mnist(void)
{
    ...
    int construct_err = mnistCNN_Construct(0);
    if (construct_err)
    {
    ...
    printf("Just deallocate/allocate the L1 buffer\n");
    mnistCNN_Destruct(1);
    construct_err = mnistCNN_Construct(1);

    printf("Just deallocate/allocate the L1 buffer and L2 dynamic buffers\n");
    mnistCNN_Destruct(2);
    construct_err = mnistCNN_Construct(2);

...
void Audio_Init()
{
    ...
    /* I2S Clock Enable  */
    SAI_ClockConfig(i2s_address[0], uSAI_Channel0, WORD_SIZE_CHAN0, EN_CHAN0, 0x0f);
}
...
void Audio_Capture()
{
    ...
    /* I2S Clock disable  */
    SAI_ClockConfig(i2s_address[0], uSAI_Channel0, WORD_SIZE_CHAN0, 0, 0x0f);

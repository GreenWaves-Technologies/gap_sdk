...

{
	...
	UserKernel(Name,
		...
		KerArgs(3,
			KerArg("KerM1",  OBJ_IN_DB|O_TILE1,  ColM1, LineM1, sizeof(Word16), 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "M1",  0),
			KerArg("KerM2",  OBJ_IN_DB,          ColM2, LineM2, sizeof(Word16), 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "M2",  0),
			KerArg("KerOut", OBJ_OUT_DB|O_TILE1, ColO,  LineO,  sizeof(Word16), 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Out", 0)
		)
	);
}
...

{
	...
	UserKernel(Name,
		...
		KerArgs(4,
			KerArg("KerBuff",OBJ_BUFFER_NTILED,  LineM2, 1,      sizeof(Word16), 0, 0,                                                0, 0,     0),
			KerArg("KerM1",  OBJ_IN_DB|O_TILE1,  ColM1, LineM1, sizeof(Word16), 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "M1",  0),
			KerArg("KerM2",  OBJ_IN_DB,          ColM2, LineM2, sizeof(Word16), 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "M2",  0),
			KerArg("KerOut", OBJ_OUT_DB|O_TILE1, ColO,  LineO,  sizeof(Word16), 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Out", 0)
		)

...
#define BRIDGE_FBOpen(__name, __width, __height, __format, __event) rt_bridge_fb_open(__name, __width, __height, __format, __event)
#define BRIDGE_FBUpdate(__fb, __addr, __posx, __posy, __width, __height, __event) rt_bridge_fb_update(__fb, __addr, __posx, __posy, __width, __height, __event)

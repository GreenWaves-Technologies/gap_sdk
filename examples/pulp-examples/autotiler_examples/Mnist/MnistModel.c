...

{
    ...
    // 1 input plane [28x28], 32 output planes [12x12]
	CNN_SmallParOutFeatConvolutionPoolReLU("Conv5x5ReLUMaxPool2x2_0",     HALF_WORD,HALF_WORD,HALF_WORD,HALF_WORD, FROM_L2, FROM_L2, FROM_L2, TO_L2,  1, 32, 28, 28, 5, 1, NO_PADDING, NO_RELU, 2, 2, NO_PADDING, NO_RELU, MAX_POOLING);
    // 5x5 Convolution followed by ReLu and then by 2x2 Max pooling. Pure SW.
    // 32 input planes [12x12], 64 output planes [4x4]
	CNN_SmallParOutFeatConvolutionPoolReLU("Conv5x5ReLUMaxPool2x2_1",     HALF_WORD,HALF_WORD,HALF_WORD,HALF_WORD, FROM_L2, FROM_L2, FROM_L2, TO_L2,  32, 64, 12, 12, 5, 1, NO_PADDING, NO_RELU, 2, 2, NO_PADDING, NO_RELU, MAX_POOLING);
#endif
    // Linear Layer, Input, Output and Coeffs on 16bits.
    // Input 64 x [4x4], Output 10
	CNN_ParOutFeatLinearLayerReLU ("LinearLayerReLU_2",		HALF_WORD,HALF_WORD,HALF_WORD,HALF_WORD, FROM_L2,FROM_L2,FROM_L2,TO_L2, 64, 10, NO_RELU);
}

...
void Cifar10Model(unsigned int L1Memory)
{
    ...
    SetL1MemorySize(L1Memory);
		...
		// 1 input plane [32x32], 8 output planes [14x14]
        CNN_SmallParOutFeatConvolutionPoolReLU("Conv5x5MaxPool2x2_SW_0",     HALF_WORD, HALF_WORD, HALF_WORD, HALF_WORD, FROM_L2, FROM_L2, FROM_L2, TO_L2,  1, 8, 32, 32, 5, 1, NO_PADDING, NO_RELU, 2, 2, NO_PADDING, NO_RELU, AVG_POOLING);
		// 5x5 Convolution followed by 2x2 Max pooling. Pure SW.
		// 8 input planes [14x14], 12 output planes [5x5]
        CNN_SmallParOutFeatConvolutionPoolReLU("Conv5x5MaxPool2x2_SW_1",     HALF_WORD, HALF_WORD, HALF_WORD, HALF_WORD, FROM_L2, FROM_L2, FROM_L2, TO_L2,  8, 12, 14, 14, 5, 1, NO_PADDING, NO_RELU, 2, 2, NO_PADDING, NO_RELU, AVG_POOLING);
	#endif
	// Linear Layer

...
# run short training for testing the flow
...
# run complete training with default parameters epochs and learning_rate
	$(MODEL_PYTHON) $(MODEL_TRAIN) $(MODEL_TRAIN_FLAGS)  --train_dir $(MODEL_TRAIN_BUILD)   $@
...
$(MODEL_GEN_EXE): $(MODEL_BUILD)/$(MODEL_SRC)
	...
	gcc -g -o $(MODEL_GEN_EXE) -I$(TILER_INC) -I$(GEN_PATH) $(MODEL_BUILD)/$(MODEL_SRC) $(GEN_PATH)/CNN_Generators.c $(GEN_PATH)/CNN_Generator_Util.c $(TILER_LIB) $(SDL_FLAGS)

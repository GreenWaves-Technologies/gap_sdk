...
training_info_path = './main_model_fine_training_info'
...
# TODO: change the optimizer and learning rate ...
...
# Ground truth
train_labels_filename = os.path.join(data_path, 'train_fine_tuning_data.csv')
val_labels_filename   = os.path.join(data_path, 'val_fine_tuning_data.csv')
test_labels_filename   = os.path.join(data_path, 'test_fine_tuning_data.csv')

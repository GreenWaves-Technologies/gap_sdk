...
from data_generator.object_detection_2d_photometric_ops import RandomRowDefect, RandomColDefect, RandomSaltPepperNoise, RandomPoissonNoise, RandomGaussianNoise 
...
class DataAugmentationConstantInputSize:
    ...
    def __init__(self,
        ...
        self.convert_to_1_channel = ConvertTo1Channel() # Make sure all images end up having 3 channels.
        ...
        self.random_RowDefect   = RandomRowDefect(prob=random_row_defect[0], thikness=random_row_defect[1])
        self.random_col_defect  = RandomColDefect(prob=random_col_defect[0], thikness=random_col_defect[1])
        self.random_salt_pepper = RandomSaltPepperNoise(prob=random_salt_pepper_noise[0], salt_vs_pepper_ratio=random_salt_pepper_noise[1], percentage=random_salt_pepper_noise[2])
        self.random_poisson     = RandomPoissonNoise(prob=random_poisson_noise[0], Lambda=random_poisson_noise[1])
        self.random_gaussian    = RandomGaussianNoise(prob=random_gaussian_noise[0], mean=random_gaussian_noise[1], sigma=random_gaussian_noise[2])

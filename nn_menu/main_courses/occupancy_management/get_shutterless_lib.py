...
print("Registration is required to download the Shutterless prefiltering library\n")

print("In case you have already registered, you can directly enter the link")
print("to the Shutterless library that you received from an email.")
...
if url == '':
    ...
    print("link for the Shutterless libray will be sent to your email address.")
    print("This information is used uniquely to keep track of Shutterless lib users.")
    ...
    url = 'https://hooks.zapier.com/hooks/catch/2624512/osnbnad/'
...
try:
    while True:
        if re.match(r"^https://.*/$", url):
            ...
            print("end with /.")
            url = ri("Enter URL from email: ")
    f = open(os.environ.get('SHUTTERLESS_LIB_URL'),"w+")
    f.write(url)
    f.close()
except:
    fatal_error("problem writing file " + os.environ.get('SHUTTERLESS_LIB_URL'))
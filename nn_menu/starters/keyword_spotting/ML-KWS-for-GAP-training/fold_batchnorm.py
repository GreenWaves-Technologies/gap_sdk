...
def fold_batch_norm(wanted_words, sample_rate, clip_duration_ms,
                           ...
                           dct_coefficient_count, model_architecture, model_size_info, quantize, preprocess):
...
def main(_):
  ...
  fold_batch_norm(FLAGS.wanted_words, FLAGS.sample_rate,
                         ...
                         FLAGS.model_architecture, FLAGS.model_size_info, FLAGS.quantize, FLAGS.preprocess)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default='/mnt/sda1/Data/ML-KWS-for-MCU/',
      help="""\

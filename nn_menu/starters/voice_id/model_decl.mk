...
# Common includes
CNN_GEN += $(TILER_BILINEAR_RESIZE_GENERATOR_PATH)/ResizeGenerator.c
CNN_GEN_INCLUDE += -I$(TILER_BILINEAR_RESIZE_GENERATOR_PATH)
CNN_LIB += $(TILER_BILINEAR_RESIZE_GENERATOR_PATH)/ResizeBasicKernels.c
CNN_LIB_INCLUDE += -I$(TILER_BILINEAR_RESIZE_GENERATOR_PATH)
